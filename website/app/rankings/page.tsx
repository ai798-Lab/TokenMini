...
export const metadata = {
  alternates: { canonical: "https://tokenmini.cc/rankings" },
  openGraph: { url: "https://tokenmini.cc/rankings" },
  title: "社区排行 · TokenMini",
  description: "TokenMini 用户自愿加入的本周 Token 消耗与 API 等价费用排行榜。",
};
  ...
  return (
    <main className="rank-page">
      <nav className="nav shell" aria-label="排行榜导航">
        <Link className="brand" href="/" aria-label="返回 TokenMini 首页">
